    ...
    <div className="about-timeline">
      <VerticalTimeline>
        ...
        >
          ...
          <p>
            대전대학교 정보통신공학과 졸업 예정이며, 학점 4.44를 유지하며 수석을
            차지하고 있습니다. 이러한 학업 성취는 제 성실함과 꾸준한 노력, 목표
            달성에 대한 열정을 대변합니다. 학업과 프로젝트를 통해 항상 최선을
            다하며, 이를 통해 미래에도 어떤 도전이든 성공적으로 해낼 자신이
            있습니다. 이러한 경험과 역량을 토대로 협력과 열정을 가지고 업무에
            임하겠으며, 회사 내에서 가치를 더할 것을 약속드립니다.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          iconStyle={{
